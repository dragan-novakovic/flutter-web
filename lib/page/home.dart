...
//        _buildNavigationArrows(),
  ...
  Widget _buildEducationSummary() {
    return Text(
      'Self managed multiple projects, worked on startups, large enterpise ERP systems, Managment aplications, online games.',
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window.open(
                "https://www.linkedin.com/in/dragan-novakovic-459745133/",
                "LinkedIn");
          },
          child: Image.network(
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/Dragan1810", "Github");
          },
          child: Image.network(
            Assets.google,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://twitter.com/Pinowood_401", "Twitter");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
